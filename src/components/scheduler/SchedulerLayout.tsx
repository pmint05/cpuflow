...
import { requiresPriority } from '@/lib/algorithms';
    ...
    <div className="min-h-screen p-4 lg:p-8 bg-background">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex items-start justify-between">
          <div>
            <h1 className="text-4xl font-bold mb-2">cpuflow</h1>
            <p className="text-muted-foreground">
              Simulate and compare CPU scheduling algorithms with interactive timelines
            </p>
          </div>
          <ThemeToggle />
        </div>
