...
const SIMULATORS = [
	...
	},
	{
		...
		onHover: "hover:ring-emerald-200 dark:hover:ring-emerald-800",
	},
	{
		...
		onHover: "hover:ring-amber-200 dark:hover:ring-amber-800",
	},
] as const;
		...
		<div className="p-4 lg:p-8">
			<div className="container mx-auto max-w-7xl">
				...
				<div className="text-center mb-12 pt-8">
					<div className="flex items-center justify-center gap-3 mb-4 flex-col">
					...
					<p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto">
						Interactive OS resource allocation simulators for learning and
						visualization. Explore CPU scheduling, deadlock avoidance, and
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
					{SIMULATORS.map((sim) => (
						<Card
							key={sim.path}
							className={cn(
								`group relative overflow-hidden transition-all ${sim.onHover}`,
							)}>
							{/* Gradient Background */}
							<div
								className={`absolute inset-0 bg-linear-to-br ${sim.color} opacity-0 group-hover:opacity-100 transition-opacity`}
							/>

							<CardHeader className="relative">
								<div className="flex items-center gap-3 mb-2">
									<div
										className={`p-2.5 rounded-lg bg-accent ${sim.iconColor}`}>
