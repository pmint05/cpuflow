...
interface DiskSettingsCardProps {
	...
	onCountJumpsChange: (value: boolean) => void;
			...
			<CardContent className="space-y-4">
				<div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-1">
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							...
							onCheckedChange={onScannerChange}
						/>
					</div>
					...
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							checked={academicEnabled}
							onCheckedChange={onAcademicChange}
						/>
					</div>
					...
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							...
							onCheckedChange={onHighlightCurrentChange}
						/>
					</div>
					...
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							...
							onCheckedChange={onShowMarkerLabelsChange}
						/>
					</div>
					...
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							...
							onCheckedChange={onShowTickLabelsChange}
						/>
					</div>
					...
					<div className="flex items-center justify-between gap-4">
						...
						<Switch
							checked={showSequenceTicks}
							onCheckedChange={onShowSequenceTicksChange}
						/>
					</div>
					<div className="flex items-center justify-between gap-4">
						<Label className="text-sm font-medium">Count Cylinder Jumps</Label>
						<Switch checked={countJumps} onCheckedChange={onCountJumpsChange} />
					</div>
					...
					{showIncludeEdges && (
						<div className="flex items-center justify-between gap-4">
							...
							<Switch
								...
								onCheckedChange={onIncludeEdgesChange}
							/>
						</div>
					)}
				</div>
				...
				<div className="space-y-4 pt-2 border-t">
					...
					<p className="text-[11px] text-muted-foreground leading-relaxed">
						Adjust the spacing between seek steps and toggle various axis
						labels.
					</p>
				</div>
			</CardContent>
